...
class CartSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cart
        fields = ['id', 'tenant', 'site', 'user', 'session_key', 'items', 'total_amount', 'created_at', 'updated_at']
        read_only_fields = ['tenant', 'site', 'user']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['tenant', 'site', 'user', 'status', 'total_amount']