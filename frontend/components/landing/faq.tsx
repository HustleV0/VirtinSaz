...
const faqs = [
  {
    question: "آیا برای استفاده از منوساز نیاز به دانش فنی دارم؟",
    answer: "خیر، منوساز به گونه‌ای طراحی شده که هر کسی بدون نیاز به دانش فنی می‌تواند وبسایت خود را بسازد. فقط کافی است اطلاعات و تصاویر محصولات خود را وارد کنید.",
  },
  {
    question: "آیا می‌توانم دامنه اختصاصی خود را متصل کنم؟",
    answer: "بله، در پلن‌های حرفه‌ای و سازمانی می‌توانید دامنه اختصاصی خود را به وبسایت متصل کنید. همچنین یک زیردامنه رایگان از menusaz.ir نیز در اختیار شما قرار می‌گیرد.",
  },
  {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            پاسخ سوالات رایج درباره منوساز
          </p>
        </motion.div>
