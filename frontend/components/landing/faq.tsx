...
const faqs = [
  {
    question: "آیا برای استفاده از وفینو نیاز به دانش فنی دارم؟",
    answer: "خیر، وفینو به گونه‌ای طراحی شده که هر کسی بدون نیاز به دانش فنی می‌تواند وبسایت خود را بسازد. فقط کافی است اطلاعات و تصاویر محصولات خود را وارد کنید.",
  },
  {
    question: "آیا می‌توانم دامنه اختصاصی خود را متصل کنم؟",
    answer: "بله، در پلن‌های حرفه‌ای و سازمانی می‌توانید دامنه اختصاصی خود را به وبسایت متصل کنید. همچنین یک زیردامنه رایگان از vofino.ir نیز در اختیار شما قرار می‌گیرد.",
  },
  {
