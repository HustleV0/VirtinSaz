      ...
      <div className="container mx-auto px-4 py-24 md:py-32 lg:py-40">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <span>وفینو برای کسب و کارهای آنلاین</span>
          </motion.div>
          ...
          >
            با وفینو به سرعت سایت فروشگاهی، سایت رستورانی و سایت کافه خود را راه اندازی کنید.
          </motion.p>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">سایت فروشگاهی</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span className="text-sm">سایت رستورانی</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span className="text-sm">سایت کافه</span>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="relative rounded-xl border border-border bg-card p-2 shadow-2xl">
            <div className="flex items-center gap-1.5 border-b border-border px-4 py-3">
              ...
              <span className="mr-4 text-xs text-muted-foreground">my-business.vofino.ir</span>
            </div>
