...
export default function TermsPage() {
  return (
    <LegalPage 
      ...
      content={
        <>
          <p>با استفاده از خدمات منوساز، شما موافقت خود را با شرایط زیر اعلام می‌کنید:</p>
          <h2 className="text-xl font-bold mt-8 mb-4">قوانین کلی</h2>
          <p>استفاده از منوساز باید مطابق با قوانین جمهوری اسلامی ایران باشد.</p>
          <h2 className="text-xl font-bold mt-8 mb-4">مالکیت معنوی</h2>
          <p>تمامی حقوق مادی و معنوی پلتفرم منوساز متعلق به این شرکت است.</p>
